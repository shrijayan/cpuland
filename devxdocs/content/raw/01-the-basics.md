...
<!-- Fetched verbatim via WebFetch tool. This is the source of truth for Chapter 1. -->

# Chapter 1: The "Basics"

[Edit on GitHub](https://github.com/hackclub/putting-the-you-in-cpu/tree/main/src/content/chapters/1-the-basics.mdx)
...
**DIAGRAM (instruction-pointer.png):** A diagram depicting a series of bytes of machine code in RAM. A highlighted byte is pointed to by an arrow labeled "Instruction Pointer," and there are arrows representing how the instruction pointer moves forward in RAM.
...
[Continue to Chapter 2: Slice Dat Time »](slice-dat-time)
