...
<!-- Fetched verbatim via WebFetch tool. This is the source of truth for Chapter 2. -->

# Chapter 2: Slice Dat Time

[Edit on GitHub](https://github.com/hackclub/putting-the-you-in-cpu/tree/main/src/content/chapters/2-slice-dat-time.mdx)
...
A slight improvement to fixed timeslice scheduling is to pick a *target latency* — the ideal longest time for a process to respond. The target latency is the time it takes for a process to resume execution after being preempted, assuming a reasonable number of processes.
...
[Continue to Chapter 3: How to Run a Program »](how-to-run-a-program)
