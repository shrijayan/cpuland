<!-- SOURCE: https://cpu.land/becoming-an-elf-lord -->
<!-- Fetched verbatim via WebFetch tool. This is the source of truth for Chapter 4. -->

# Chapter 4: Becoming an Elf-Lord

[Edit on GitHub](https://github.com/hackclub/putting-the-you-in-cpu/tree/main/src/content/chapters/4-becoming-an-elf-lord.mdx)
...
**IMAGE (gnu-linux-elf-drawing.jpg):** A marker drawing on paper. A wizard elf is shown meditating, holding the head of a gnu in one hand and a Linux penguin in the other. The elf trails off, saying "Well, actually, Linux is just the kernel, the operating system is…" The drawing is captioned in red marker: "You've heard of elf on a shelf! Now, get ready for… elf on a GNU/Linux." (Drawing credit: Nicky Case.)
...
**DIAGRAM (elf-section-header-table-diagram.png):** An old treasure map with islands, rivers, palm trees, and a compass rose. Some of the islands are labeled with ELF section names such as ".text", ".data", ".shstrtab", and ".bss". The drawing is captioned "The section header table is like a map for binary data."
...
[Continue to Chapter 5: The Translator in Your Computer »](the-translator-in-your-computer)
